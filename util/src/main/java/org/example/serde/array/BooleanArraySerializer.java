...
public class BooleanArraySerializer implements Serializer<boolean[]> {
  ...
  public BooleanArraySerializer(CommonSerializer serializer) {
  ...
  public void writeObject(ByteBuf buf, boolean[] object) {
    SerializerPair pair = serializer.getSerializerPair(Boolean.TYPE);
    if (pair == null) {
      throw new RuntimeException("类型:" + Boolean.TYPE + ",未注册");
    }

...
public class CharArraySerializer implements Serializer<char[]> {
  ...
  public CharArraySerializer(CommonSerializer serializer) {
  ...
  public void writeObject(ByteBuf buf, char[] object) {
    SerializerPair pair = serializer.getSerializerPair(Character.TYPE);
    if (pair == null) {
      throw new RuntimeException("类型:" + Character.TYPE + ",未注册");
    }
